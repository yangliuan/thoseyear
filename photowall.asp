...
<link href="css/css_pirobox/style_2/pstyle.css" rel="stylesheet" type="text/css" />
...
#Nxnphoto-list{
	background-image: url(<%=photoWallBG%>);
...
<div id="mainbody">
  ...
  <div id="navd">
    <div id="logo"><a href="<%=valueArray(4)%>" target="_self"><img src="<%=valueArray(3)%>" width="200" height="100" style="border:0px"/></a></div>  <div id="link"><a href="index.asp">[首页]</a>&nbsp;<a href="aboutme.asp" target="_self">[那些年的我]</a>&nbsp;<a href="mydiary.asp" target="_self">[那些年的日记]</a>&nbsp;<a href="myphoto.asp" target="_self">[那些年的相片]</a>&nbsp;<a href="myvideo.asp" target="_self">[那些年的影像]</a>&nbsp;<a href="contact.asp" target="_self">[联系我]</a>&nbsp;&nbsp;&nbsp;&nbsp;</div></div>
  <!--end navd-->
  <div id="Nxnphoto-list">
  <span class="titleimg"><img src="images/Nxn-photo.png" width="150" height="33" /></span><span class="localtion-nav">当前位置：首页->那些年的相片->相片墙</span>
