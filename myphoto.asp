...
<div id="mainbody">
  ...
  <!--end navd-->
  <div id="photo-class">
  <span class="titleimg"><img src="images/Nxn-photo.png" width="150" height="33" /></span><span id="localtionbg" class="localtion-nav">当前位置：首页->那些年的相片-相册</span>
   ...
   <span class="tishi">点击图片可切换相册↑</span>
