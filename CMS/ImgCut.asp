...
Dim PhotoUrl:PhotoUrl=Request.QueryString("photourl")
if PhotoUrl="" Then
...
<body>
<iframe src="imgcut.asp?action=main&photourl=<%=photourl%>" scrolling="yes" width="100%" height="540"></iframe>
</body>
</html>
<%
end if
...
<script language="javascript" type="text/javascript" src="../script/Drag.js"></script>
<script language="javascript" type="text/javascript" src="../script/ImgCropper.js"></script>
<script language="javascript" type="text/javascript" src="../script/Resize.js"></script>
...
#rRightDown{right:0px;bottom:0px;background-color:#fff;}
...
<table border="0" width="99%" bgcolor="#ffffff" align="center" cellspacing="0" cellpadding="0">
  <tr>
	...
	<div id="viewDiv" style="border:3px solid #000;width:200px; min-height:120px;"> </div>
	  ...
	  <tr>
	   <td style="height:40px;color:#ff6600;font-size:12px">
		...
		<input name="" type="button" value="确认裁切" onclick="Create()" />
    <input name="" type="button" value="取消裁切" onclick="top.close()"/>
        </form>
        裁切大图时不建议使用IE8.0及以下版本的浏览器。
	   </td>
	  </tr>
	  </table>
	</td>
